VKontakte = function (bNesisApi) {
	 ...
	 *  Gets frends of the user
	 * https://vk.com/dev/friends.get 	
	 * @return {VKontakteFriendsGet} Returns a list of user IDs or detailed information about a user's friends.
	 */
...
/**
 * The response 
 * @typedef {Object} VKontakteFriendsGetResponse
 */
 VKontakteFriendsGetResponse = function () { 
	/**
 ...
 * @typedef {Object} VKontakteFriendsGet
 */
 VKontakteFriendsGet = function () { 
	/**
	 * the response.
	 * @type {VKontakteFriendsGetResponse}
	 */
	this.response = new VKontakteFriendsGetResponse();
