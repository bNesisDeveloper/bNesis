Mega = function (bNesisApi) {
	 ...
	 */
    this.Auth = function (bNesisDevId,clientSecret,redirectUrl,login,password) {
		if(arguments.length !== 1){
			var bNesisToken = _bNesisApi.Auth("Mega", "",bNesisDevId,redirectUrl,"",clientSecret,null,login,password,false,"");
			return bNesisToken;
		}
		else{
    ...
    this.LogoffService = function () {
		var result = _bNesisApi.LogoffService("Mega", this.bNesisToken);
    ...
    this.ValidateToken = function () {
        var result = _bNesisApi.Call("Mega", this.bNesisToken, "ValidateToken");
        return result;
    }
    ...
    this.Logoff = function () {
        var result = _bNesisApi.Call("Mega", this.bNesisToken, "Logoff");
        return result;
    }
