...
//import bNesis.Sdk.eCommerce.Shopify.Shopify;
...
public class MainServlet extends HttpServlet {
    ...
    {      
       mymsg = "bNesis Sdk Shopify Auth Example";   
    }
        ...
        IOException 
    {
    	...
    	try {
	    	...
	    	if(bNesisToken == "" || bNesisToken == null)
	    	{
		    	...
		    	String ShopifyApiKey = request.getParameter("ClientId");
		    	String ShopifyApiSecret = request.getParameter("ClientSecret");
		    	String redirectUrl = request.getParameter("redirectUrl");
		    	String[] Scopes = {"write_orders", "read_customers"};
		    	manager.CreateInstanceShopify( bNesisDeveloperId, ShopifyApiKey, ShopifyApiSecret, redirectUrl, Scopes);
	    	...
	    	else
	    	{
		    	...
		    	//shopify.bNesisToken = bNesisToken;
	        		        	
	            response.setContentType("text/html");
	            // Writing the message on the web page      
	            out.println("<h1>" + mymsg + "</h1>");      
	            out.println("<p>" + "Authorization success! Shopify instance created.!" + "</p>");   	        	
	    	}
    	}
    	catch(Exception e)
    	{
