...
This web application example shows how to use bNesis SDK initialization, authentication and calls GetCompanyProfileV1 method from LinkedIn service and save the result of calling in XML format file.
