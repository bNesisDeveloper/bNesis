...
This console example shows how to use bNesis SDK initialization, authentication and how to get the information about the education of the user with scope "user_education_history" in Facebook service. All data are saved to the XML file.
