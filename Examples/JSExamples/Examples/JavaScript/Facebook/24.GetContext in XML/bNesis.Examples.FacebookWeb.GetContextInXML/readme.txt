...
This web application example shows how to use bNesis SDK initialization, authentication and to get social context for this person in Facebook service. Use with scopes. All data will be saved to the XML file.
