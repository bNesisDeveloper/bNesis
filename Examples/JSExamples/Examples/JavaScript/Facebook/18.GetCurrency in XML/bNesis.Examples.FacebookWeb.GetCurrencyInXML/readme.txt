...
This web application example shows how to use bNesis SDK initialization, authentication and to get the person's local currency information in Facebook service. Use without scope. All data are wroten to the XML file.
