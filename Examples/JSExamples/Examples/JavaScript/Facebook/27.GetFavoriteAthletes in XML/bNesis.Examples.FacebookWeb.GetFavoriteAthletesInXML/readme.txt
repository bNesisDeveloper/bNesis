...
This web application example shows how to use bNesis SDK initialization, authentication and to get person's athletes likes in Facebook service. Use with scopes "user_likes". All data will be wroten to the XML file.
