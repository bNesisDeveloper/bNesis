...
/// </summary>
namespace bNesis.Examples.ProzzoroApp.Simple
{
    /// <summary>
    ...
    /// <para/>bNesis ServiceManager GetTenerByIdentifier method
    /// <para/>
    ...
    internal class Program
    {
        ...
        {
            Console.WriteLine("bNesis SDK - Prozzoro simple example.\n");
            ...
            else
            {
                ...
                try
                {
                    ...
                    Console.WriteLine("Get tender...");
                    //Set tender identifier
                    string tenderId = "c8c59ec1995f4dada1a2b5bc01309330";
                    //Gets tender by identifier
                    ProzzoroTender tender = prozzoro.GetTenderByIdentifier(tenderId);
                    //Getting last error
                    ErrorInfo errorInfo = prozzoro.GetLastError();
                    //Check if errorInfo code does not equal noError
                    if (errorInfo.Code != ServiceManager.errorCodeNoError)
                    {
                        Console.WriteLine("Can't get tender, error code: " + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! Recieved information about tender.");
                    Console.WriteLine("Some tender infromation:" +
                                      "\n Title:" + tender.title +
