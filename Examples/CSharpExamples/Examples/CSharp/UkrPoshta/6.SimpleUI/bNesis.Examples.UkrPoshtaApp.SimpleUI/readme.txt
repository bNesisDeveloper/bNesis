Example of WPF application with simple UI.

This WPF application shows how to use bNesis SDK initialization, authentication and call some methods from UkrPoshta service.  
