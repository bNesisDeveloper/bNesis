...
1. If you use Thin Client, you do not need access to bNesis API Server. Address of the demo server https://server2.bnesis.com
2. To use the bNesis SDK in your applications, you must use the bNesis Developer ID - the key that signs your copy of the bNesis SDK. To study bNesis SDK, tests and demonstrations, you can get the key to https://api.bnesis.com site completely free, and free of charge.
3. The developers of bNesis offer you to adhere to the following sequence of API usage:
3.1 Connect bNesis SDK modules to your application.
3.2 Use the bNesis SDK ServiceManager class to initialize clients of different types:
	The InitializeRich method for RichClient
	The InitializeThin method for RichThin
3.3 After initialization, you need to select the service with which you plan to work in your application and implement your application authorization procedure in the selected service using ServiceManager CreateInstance method. You also need to specify bNesis Developer Id in this method.
