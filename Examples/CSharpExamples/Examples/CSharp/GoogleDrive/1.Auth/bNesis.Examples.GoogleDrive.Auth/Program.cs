...
namespace bNesis.Examples.GoogleDriveApp.Auth
{
    /// <summary>
    ...
    /// <para/>bNesis ServiceManager CreateInstanceGoogleDrive method
    /// <para/>
    ...
    /// (Google+ APIs require an authorization for all Google services)
    ...
    internal class Program
    {
        ...
        /// <summary>
        /// If you use the Thin Client mode, you need an access to a bNesis API Server. Addresses of the available demo bNesis API Servers see above
        /// </summary>
        ...
        {
            Console.WriteLine("bNesis SDK - GoogleDrive authentication example\n");
...
/// Using of this method does not protect your data
            ...
            {
                Console.WriteLine(
                    "For using this example you need Google authentication keys, please setup your Google Developer account and create an credentials OAuth in https://console.developers.google.com/apis/credentials \n");
                Console.WriteLine("Press any key to exit...");
                Console.ReadKey();
                return;
            }
            ...
            else
            {
                ...
                catch (Exception ex)
                {
                    ...
                    Console.WriteLine("Creating of the instance 'GoogleDrive' is failed, reason: " + ex.Message);
                }
            }
