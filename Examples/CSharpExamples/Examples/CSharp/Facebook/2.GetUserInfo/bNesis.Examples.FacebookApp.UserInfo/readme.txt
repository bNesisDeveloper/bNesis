...
This console example shows how to use bNesis SDK initialization, authentication and receiving  data of an authorized user and his friends who gave permission to provide data to the FacebookApp.
