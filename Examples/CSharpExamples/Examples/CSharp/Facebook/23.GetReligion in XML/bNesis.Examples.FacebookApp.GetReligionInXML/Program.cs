...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetReligionInXML
{
    /// <summary>
    /// This console example shows how to use bNesis SDK initialization, authentication and to get the person's religion.
    /// Use with a scope "user_religion_politics".
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    //Getting the person's religion
                    Response religion = facebook.GetUserReligionRaw("me");
                    ...
                    {
                        //Show error message
                        Console.WriteLine("Getting the person's religion is Failed, error code:" + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! The person's religion is received.\n");
                    ...
                    Console.WriteLine("The person's religion is saved to the folder \"container\" in the application folder.\n");
