...
This console example shows how to use bNesis SDK initialization, authentication and to get the person's religion in Facebook service. Use with a scope "user_religion_politics".
