...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetFavoriteTeamsInXML
{
    /// <summary>
    /// This console example shows how to use bNesis SDK initialization, authentication and to get sport teams in the person's likes.
    /// Use with scopes "user_likes".
    ...
    internal class Program
    {
        ...
        /// </summary>
        private static string[] Scope = new string[] { "user_likes" };
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    //Getting sport teams in the person's likes
                    Response favoriteTeams = facebook.GetUserFavoriteTeamsRaw("me");
                    ...
                    {
                        //Show error message
                        Console.WriteLine("Getting of Sport teams in the person likes is Failed, error code:" + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! Sport teams in the person likes are received.\n");
                    ...
                    XDocument xml = XDocument.Load(JsonReaderWriterFactory.CreateJsonReader(
                        Encoding.ASCII.GetBytes(favoriteTeams.Content), new XmlDictionaryReaderQuotas()));

                    //Writing xml document to the file 
                    Directory.CreateDirectory("container");
                    xml.Save("container/data.xml", SaveOptions.None);

                    Console.WriteLine("Sport teams from the person likes are saved to the folder \"container\" in the application folder.\n");
                }
