...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetDevicesInXML
{
    /// <summary>
    /// This console example shows how to use bNesis SDK initialization, authentication and to get the list devices of the user without scopes.
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    //Getting the devices of the user
                    Response devices = facebook.GetUserDevicesRaw("me");
                    ...
                    {
                        //Show error message
                        Console.WriteLine("Getting the devices of user is Failed, error code:" + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! The devices of the user is received");
                    ...
                    XDocument xml = XDocument.Load(JsonReaderWriterFactory.CreateJsonReader(
                        Encoding.ASCII.GetBytes(devices.Content), new XmlDictionaryReaderQuotas()));

                    //Writing xml document to the file in 
                    Directory.CreateDirectory("container");
                    xml.Save("container/data.xml", SaveOptions.None);

                    Console.WriteLine("The User's devices are saved to the folder \"container\" in the application folder.");
