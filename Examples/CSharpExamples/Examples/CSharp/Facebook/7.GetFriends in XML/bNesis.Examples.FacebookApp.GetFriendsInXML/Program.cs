...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetFriendsInXML
{
    /// <summary>
    /// This console example shows how to use bNesis SDK initialization, authentication and how to get user friends with the scope "user_friends". 
    /// All data are wroten to XML file in a folder \"container\" in the application folder.
    ...
    internal class Program
    {
        ...
        /// <summary>
        /// If you use a Thin Client mode, you need an access to a bNesis API Server. Addresses of demo bNesis API servers:
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    Response listFriends = facebook.GetFieldsUserFriendsRaw(id);
                    ...
                    Console.WriteLine("Success! Friends are received.");

                    Console.WriteLine("Data will be Saved to XML file...");
                    
                    //Convert JsonString Response to XML document
                    XDocument xml = XDocument.Load(JsonReaderWriterFactory.CreateJsonReader(
                        Encoding.ASCII.GetBytes(listFriends.Content), new XmlDictionaryReaderQuotas()));

                    //Writing xml document to the file 
                    Directory.CreateDirectory("container");
                    xml.Save("container/data.xml", SaveOptions.None);
                    
                    Console.WriteLine("Friends are saved to a folder \"container\" in a application folder.");
