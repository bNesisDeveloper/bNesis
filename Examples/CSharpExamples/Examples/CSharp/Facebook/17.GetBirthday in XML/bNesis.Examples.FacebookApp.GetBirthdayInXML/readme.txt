...
This console example shows how to use bNesis SDK initialization, authentication and to get the birthday of the user with scope "user_birthday" in Facebook service.
All data are saved to the XML file to the folder \"container\" in the application folder.
