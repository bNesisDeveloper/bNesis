...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetBirthdayInXML
{
    /// <summary>
    /// This console example shows how to use bNesis SDK initialization, authentication and to get the birthday of the user with scope "user_birthday".
    ...
    internal class Program
    {
        ...
        /// </summary>
        private static string[] Scope = new string[] { "user_birthday" };
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    Response birthday = facebook.GetUserBirthdayRaw("me");
                    ...
                    {
                        //Show error message
                        Console.WriteLine("Getting the user's birthday is Failed, error code:" + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! The user's birthday is received\n");
                    ...
                    XDocument xml = XDocument.Load(JsonReaderWriterFactory.CreateJsonReader(
                        Encoding.ASCII.GetBytes(birthday.Content), new XmlDictionaryReaderQuotas()));

                    //Writing xml document to the file 
                    Directory.CreateDirectory("container");
                    xml.Save("container/data.xml", SaveOptions.None);

                    Console.WriteLine("The user's birthday is saved to the folder \"container\" in the application folder.\n");
