...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetHometownInXML
{
    /// <summary>
    /// This console example shows how to use bNesis SDK initialization, authentication and how to get a person's hometown.
    /// Use with the scope "user_hometown".
    ...
    internal class Program
    {
        ...
        /// </summary>
        private static string[] Scope = new string[] { "user_hometown" };
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    //Getting a person's hometown
                    Response hometown = facebook.GetUserHometownRaw("me");
                    ...
                    {
                        //Show error message
                        Console.WriteLine("Getting the person's hometown is Failed, error code:" + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! The person's hometown is received\n");
                    ...
                    XDocument xml = XDocument.Load(JsonReaderWriterFactory.CreateJsonReader(
                        Encoding.ASCII.GetBytes(hometown.Content), new XmlDictionaryReaderQuotas()));

                    //Writing xml document to the file in 
                    Directory.CreateDirectory("container");
                    xml.Save("container/data.xml", SaveOptions.None);

                    Console.WriteLine("The person's hometown is saved to the folder \"container\" in the application folder.\n");
