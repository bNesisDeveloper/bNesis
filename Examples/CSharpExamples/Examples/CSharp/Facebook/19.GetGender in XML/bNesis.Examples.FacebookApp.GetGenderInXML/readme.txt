...
This console example shows how to use bNesis SDK initialization, authentication and how to get a person's gender, male or female in Facebook service. Use without scope. All data are wroten to the XML file to the folder "container" in the application folder.
