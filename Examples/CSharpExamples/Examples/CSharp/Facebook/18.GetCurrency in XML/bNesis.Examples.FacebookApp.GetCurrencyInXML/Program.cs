...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetCurrencyInXML
{
    /// <summary>
    /// This console example shows how to use bNesis SDK initialization, authentication and to get the person's local currency information. 
    /// Use without scope.
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    //Getting the person's local currency information
                    Response currency = facebook.GetUserCurrencyRaw("me");
                    ...
                    {
                        //Show error message
                        Console.WriteLine("Getting of the person's local currency information is Failed, error code:" + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! The person's local currency information is received\n");
                    ...
                    Console.WriteLine("The person's local currency information is saved to the folder \"container\" in the application folder.\n");
