...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetPhoto
{
    /// <summary>
    /// This console example shows how to use bNesis SDK initialization, authentication and to get photos including likes and comments. Using scope "user_photos".
    ...
    internal class Program
    {
        ...
        /// <summary>
        /// An entry point for a Console application.
        /// </summary>
        ...
        static void Main(string[] args)
        {
...
#if (ExampleMode)
            /// Use this method only for testing and demonstration of applications
            ...
            else
            {
                ...
                try
                {
                    ...
                    //Getting photos
                    FacebookUserPhotos photo = facebook.GetUserPhotos("me");
                    ...
                    Console.WriteLine("Success! The data of photos is received");
