...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetEducationInXML
{
    /// <summary>
    /// This console example shows how to use bNesis SDK initialization, authentication and how to get the information about the education of the user with scope "user_education_history".
    ...
    internal class Program
    {
        ...
        /// </summary>
        private static string[] Scope = new string[] { "user_education_history" };
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    //Getting the education of the user
                    Response education = facebook.GetUserEducationRaw("me");
                    ...
                    {
                        //Show error message
                        Console.WriteLine("Getting the education of user is Failed, error code:" + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! The information about the user education is received\n");
                    ...
                    XDocument xml = XDocument.Load(JsonReaderWriterFactory.CreateJsonReader(
                        Encoding.ASCII.GetBytes(education.Content), new XmlDictionaryReaderQuotas()));

                    //Writing xml document to the file
                    Directory.CreateDirectory("container");
                    xml.Save("container/data.xml", SaveOptions.None);

                    Console.WriteLine("The user's education information is saved to the folder \"container\" in the application folder.\n");
