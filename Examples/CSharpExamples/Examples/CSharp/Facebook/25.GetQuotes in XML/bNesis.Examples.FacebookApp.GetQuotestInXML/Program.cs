...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetQuotesInXML
{
    /// <summary>
    /// This console example shows how to use bNesis SDK initialization, authentication and to get the person's favorite quotes.
    /// Use with the scope "user_likes".
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    //Getting the person's favorite quotes
                    Response religion = facebook.GetUserQuotesRaw("me");
                    ...
                    {
                        //Show error message
                        Console.WriteLine("Getting the person's favorite quotes is Failed, error code:" + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! The person's favorite quotes are received.\n");
                    ...
                    Console.WriteLine("The person's favorite quotes is saved to folder \"container\" in the application folder.\n");
