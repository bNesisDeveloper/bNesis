...
This console example shows how to use bNesis SDK initialization, authentication and to get the information about the work of the user with scope "user_work_history" in Facebook service. All data will be saved to the XML file to the folder \"container\" in the application folder.
