...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetWorkInXML
{
    /// <summary>
    /// This console example shows how to use bNesis SDK initialization, authentication and to get the information about the work of the user with scope "user_work_history".
    ...
    internal class Program
    {
        ...
        /// </summary>
        private static string[] Scope = new string[] { "user_work_history" };
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    //Getting the work of the user
                    Response work = facebook.GetUserWorkRaw("me");
                    ...
                    {
                        //Show error message
                        Console.WriteLine("Getting of the user's work is Failed, error code:" + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! The information about the work of the user is received\n");
                    ...
                    XDocument xml = XDocument.Load(JsonReaderWriterFactory.CreateJsonReader(
                        Encoding.ASCII.GetBytes(work.Content), new XmlDictionaryReaderQuotas()));

                    //Writing xml document to the file
                    Directory.CreateDirectory("container");
                    xml.Save("container/data.xml", SaveOptions.None);

                    Console.WriteLine("The information about the user's work is saved to the folder \"container\" in the application folder.\n");
