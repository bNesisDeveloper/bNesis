...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetFeed
{
    /// <summary>
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Waiting for a pressed key. If key is not 'R', you will use a Thin client mode as a default.
            ...
            else
            {
                ...
                try
                {
                    ...
                    FacebookFeed feedPosts = facebook.GetUserFeed("me");
                    ...
                    {
                        //Show error message
                        Console.WriteLine("Getting of the feed of posts is Failed, error code:" + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! The feed of  {0} posts is received \n\r", feedPosts.data.Length);

                    if (feedPosts.data.Length > 0)
                    {
                        for(int i=0; i < feedPosts.data.Length; i++)
                        {
                            Console.WriteLine("Post {0} with id {1}", i + 1, feedPosts.data[i].id);
                        }
                    }
