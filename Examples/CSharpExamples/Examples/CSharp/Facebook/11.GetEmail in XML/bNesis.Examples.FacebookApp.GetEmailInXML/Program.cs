...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetEmailInXML
{
    /// <summary>
    /// This console example shows how to use bNesis SDK initialization, authentication and to get the email of the user.
    ...
    internal class Program
    {
        ...
        /// </summary>
        private static string[] Scope = new string[] {"email"};
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    //Getting the email
                    Response email = facebook.GetUserEmailRaw("me");
                    ...
                    {
                        //Show error message
                        Console.WriteLine("Getting the email of user is Failed, error code:" + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! The email of the user is received");
                    ...
                    XDocument xml = XDocument.Load(JsonReaderWriterFactory.CreateJsonReader(
                        Encoding.ASCII.GetBytes(email.Content), new XmlDictionaryReaderQuotas())); 

                    //Writing xml document to a file 
                    Directory.CreateDirectory("container");
                    xml.Save("container/data.xml", SaveOptions.None);

                    Console.WriteLine("User's email is saved to the folder \"container\" in the application folder.");
