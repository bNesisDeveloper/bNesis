...
This console example shows how to use bNesis SDK initialization, authentication and to get the person's political views in Facebook service. Use with the scope "user_religion_politics". All data will be wroten to the XML file to the folder "container" in the application folder.
