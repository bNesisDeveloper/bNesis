...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetPoliticalInXML
{
    /// <summary>
    /// This console example shows how to use bNesis SDK initialization, authentication and to get the person's political views.
    /// Use with the scope "user_religion_politics".
    ...
    internal class Program
    {
        ...
        /// </summary>
        private static string[] Scope = new string[] { "user_religion_politics" };
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    //Getting the person's political views
                    Response politViews = facebook.GetUserPoliticalRaw("me");
                    ...
                    {
                        //Show error message
                        Console.WriteLine("Getting the person's political views is Failed, error code:" + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! The person's political views is received\n");
                    ...
                    XDocument xml = XDocument.Load(JsonReaderWriterFactory.CreateJsonReader(
                        Encoding.ASCII.GetBytes(politViews.Content), new XmlDictionaryReaderQuotas()));

                    //Writing xml document to the file
                    Directory.CreateDirectory("container");
                    xml.Save("container/data.xml", SaveOptions.None);

                    Console.WriteLine("The person's political views is saved to the folder \"container\" in the application folder.\n");
