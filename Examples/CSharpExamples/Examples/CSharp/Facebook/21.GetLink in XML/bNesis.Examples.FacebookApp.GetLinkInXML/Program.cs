...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetLinkInXML
{
    /// <summary>
    /// This console example shows how to use bNesis SDK initialization, authentication and to get a link to the person's Timeline.
    /// Use without scope.
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    //Getting a link to the person's Timeline
                    Response link = facebook.GetUserLinkRaw("me");
                    ...
                    {
                        //Show error message
                        Console.WriteLine("Getting a link to the person's Timeline is Failed, error code:" + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! A link to the person's Timeline is received\n");
                    ...
                    XDocument xml = XDocument.Load(JsonReaderWriterFactory.CreateJsonReader(
                        Encoding.ASCII.GetBytes(link.Content), new XmlDictionaryReaderQuotas()));

                    //Writing xml document to the file
                    Directory.CreateDirectory("container");
                    xml.Save("container/data.xml", SaveOptions.None);

                    Console.WriteLine("A person's Timeline link is saved to the folder \"container\" in the application folder.\n");
