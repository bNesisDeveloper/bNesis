...
This console example shows how to use bNesis SDK initialization, authentication and calls GetCompanyProfileV1 method from LinkedIn service and save the result of calling in XML format file.
...
3.3 After initialization, you neovhodimo select the service with which you plan to work in your application and implement your application authorization procedure in the selected service using ServiceManager CreateInstance method. You also need to specify bNesis Developer Id in this method.
