...
/// </summary>
namespace bNesis.Examples.LinkedInApp.GetMemberProfileV1InXML
{
    /// <summary>
    ...
    /// <para/>bNesis LinkedIn GetMemberProfileV1 method
    /// <para/>
    /// <para/>Also this example demonstrates methods of getting a bNesis SDK status information, error handling and service control. 
    /// </summary>
    internal class Program
    {
        ...
        private static string[] Scope = new string[] { "r_basicprofile", "r_emailaddress" };
        ...
        {
            Console.WriteLine("bNesis SDK - LinkedIn getting member profile in XML example.\n");
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        Console.WriteLine("Can't receive profile, error code: " + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! Member's profile is received.");
                    ...
                    //Writting xml document to the file 
                    xml.Save("container/data.xml", SaveOptions.None);

                    Console.WriteLine("Member profile is saved to the folder \"container\" in the application folder ");
                }
                catch (Exception ex)
                {
