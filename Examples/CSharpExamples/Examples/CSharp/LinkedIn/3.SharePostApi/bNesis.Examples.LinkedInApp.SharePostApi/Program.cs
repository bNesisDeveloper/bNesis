...
namespace bNesis.Examples.LinkedInApp.SharePostApi
{
    ...
    internal class Program
    {
        ...
        /// Attention: 'w_share' has daily limits to use it, please see about limits on https://developer.linkedin.com/docs/share-on-linkedin
        /// </summary>
        /// "w_share"
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    Console.WriteLine(
                        "Input your share message and press Enter. if line will be empty, the message will not be shared.");
                    ...
                    //Share a new message for a current authorized member
                    linkedIn.SharePost(contentShare);
                    //Getting last error
                    ...
                    {
                        Console.WriteLine("Can't share a message, error code: " + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! The message was posted for the current authorized member.");
