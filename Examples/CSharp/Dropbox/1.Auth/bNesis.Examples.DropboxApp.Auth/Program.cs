...
namespace bNesis.Examples.DropboxApp.Auth
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Check a Dropbox authentication keys
            if (string.IsNullOrEmpty(appKey) || string.IsNullOrEmpty(appSecret))
            {
                Console.WriteLine("For using this example you need an Dropbox authentication keys, please setup your Dropbox Developer account and create an application\n");
                Console.WriteLine("Press any key to exit...");
                Console.ReadKey();
                return;
            }
