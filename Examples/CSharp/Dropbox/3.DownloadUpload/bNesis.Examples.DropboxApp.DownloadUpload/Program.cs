...
namespace bNesis.Examples.DropboxApp.DownloadUpload
{
    ...
    internal class Program
    {
        ...
        /// Rich client:
        /// http://localhost:809/  
        /// (as a default the bNesis Rich client redirects host and port, see redirectUrl property)
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    //Create the instance of the dropbox service
                    ...
                    string destinitionFileName = Path.GetFileName(fileName);

                    //Upload File
                    string uploadResult = dropbox.UploadFile(uploadStream, destinitionFileName);
                    ...
                    else //begin downloading of the uploaded file back to local drive
                    {
                        ...
                        Console.WriteLine("Now download the file from Dropbox and save it at the new file: " + fileName + "_dropbox");

                        //download the file from Dropbox                        
                        Stream downloadStream = dropbox.DownloadFile(destinitionFileName);
