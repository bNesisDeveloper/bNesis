...
/// </summary>
namespace bNesis.Examples.LinkedInApp.SharePostApi
{
    /// <summary>
    ...
    /// <para/>bNesis LinkedIn SharePost method
    /// <para/>
    ...
    internal class Program
    {
        ...
        /// Attention: 'w_share' have daily limits on use, please see about limits on https://developer.linkedin.com/docs/share-on-linkedin
        /// </summary>
        /// "r_basicprofile", "w_share"
        private static string[] Scope = new string[] { "w_share" };
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    Console.WriteLine("Press on keyboard Enter to share message below, if line empty then message will not shared.");
                    ...
                    //Creating new LinkedInShare and set properties.
                    LinkedInShare contentShare = new LinkedInShare();
                    LinkedInVisibility visibility = new LinkedInVisibility();

                    visibility.code = "connections-only";
                    contentShare.visibility = visibility;
                    contentShare.comment = message;
          
                    //Share new message for current authorized member
                    bool isSharePost = linkedIn.SharePost(contentShare);
                    //Getting last error
                    ...
                    //Check if share was post.
                    if (isSharePost)
                    {
                        Console.WriteLine("Success! The message was posted for current authorized member.");
                    }
                    else
                    {
                        //If share was failed post, show error message.
                        Console.WriteLine("Failed! The message was not posted for current authorized member." +
                                          "\n Possible reason:" +
                                          "\n  Application used all daily call limits," +
                                          "\n  see limits with 'w_share' on https://developer.linkedin.com/docs/share-on-linkedin.");
                    }
