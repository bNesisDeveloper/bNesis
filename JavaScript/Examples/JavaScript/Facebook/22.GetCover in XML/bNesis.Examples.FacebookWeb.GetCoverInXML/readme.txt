...
This web application example shows how to use bNesis SDK initialization, authentication and to get the person's cover photo in Facebook service. Use without scopes. All data will be wroten to the XML file. 
