...
This web application example shows how to use bNesis SDK initialization, authentication and receiving  data of an authorized user and his friends who gave a permission to provide data to the FacebookApp. All data will be saved to XML file.
