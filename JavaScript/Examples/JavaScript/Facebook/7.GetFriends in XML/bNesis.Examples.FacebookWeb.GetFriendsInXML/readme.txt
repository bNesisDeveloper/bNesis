...
This web application example shows how to use bNesis SDK initialization, authentication and how to get user friends with the scope "user_friends" in Facebook service.
All data will be written to XML file.
