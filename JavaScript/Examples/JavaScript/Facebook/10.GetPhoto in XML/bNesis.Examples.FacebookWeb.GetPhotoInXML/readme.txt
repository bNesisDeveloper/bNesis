...
This web application example shows how to use bNesis SDK initialization, authentication and to get photos including likes and comments in Facebook service. Using scope "user_photos". All data will be saved in XML file.
