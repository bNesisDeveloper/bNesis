...
This web application example shows how to use bNesis SDK initialization, authentication and how to get a person's hometown in Facebook service. Use with the scope "user_hometown". All data are wroten to the XML file.
