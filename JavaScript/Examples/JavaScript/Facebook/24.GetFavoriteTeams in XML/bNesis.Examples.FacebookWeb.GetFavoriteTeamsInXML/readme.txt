...
This web application example shows how to use bNesis SDK initialization, authentication and to get sport teams in the person's likes in Facebook service. Use with scopes "user_likes". All data will be wroten to the XML file. 
