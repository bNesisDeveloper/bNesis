...
This web application example shows how to use bNesis SDK initialization, authentication and to get the email of the user in Facebook service.
All data are saved to the XML file.
