...
This web application example shows how to use bNesis SDK initialization, authentication and to get the location of the user with scope "user_location" in Facebook service. All data are saved to the XML file.
