...
This web application example shows how to use bNesis SDK initialization, authentication and to get the person's favorite quotes in Facebook service.Use with the scope. All data will be wroten to the XML file.
