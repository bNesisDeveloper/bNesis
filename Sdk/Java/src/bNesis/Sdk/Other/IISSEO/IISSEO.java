package bNesis.Sdk.Other.IISSEO;
...
import bNesis.Sdk.Common.*;
	...
	public class IISSEO  
	{
		...
		public IISSEO(bNesisApi bnesisApi)
		{
		...
		{
			bNesisToken = _bNesisApi.Auth("IISSEO", "",bNesisDevId,redirectUrl,"","",null,"","",false,"");
			return bNesisToken;
		}
		...
		{
			Boolean result = _bNesisApi.LogoffService("IISSEO", bNesisToken);
		...
		{
			return _bNesisApi.<ErrorInfo>Call(ErrorInfo.class, "IISSEO", bNesisToken, "GetLastError");
		}
		...
		{
			return _bNesisApi.<ErrorInfo[]>Call(ErrorInfo[].class, "IISSEO", bNesisToken, "GetErrorLog");
		}
		...
		{
			return _bNesisApi.<Boolean>Call(Boolean.class, "IISSEO", bNesisToken, "ValidateToken");
		}
	 ...
	 * if token doesn't support token revocation or token is revoked method returns false 
		...
		{
			return _bNesisApi.<Boolean>Call(Boolean.class, "IISSEO", bNesisToken, "Logoff");
		}
}