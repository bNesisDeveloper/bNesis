package bNesis.Sdk.FileStorages.BaiduBCS;
...
import java.net.URI.*;
	...
	public class BaiduBCS  
	{
		...
		public BaiduBCS(bNesisApi bnesisApi)
		{
		...
		{
			bNesisToken = _bNesisApi.Auth("BaiduBCS", "",bNesisDevId,redirectUrl,clientId,clientSecret,null,"","",false,"");
			return bNesisToken;
		}
		...
		{
			Boolean result = _bNesisApi.LogoffService("BaiduBCS", bNesisToken);
		...
		{
			return _bNesisApi.<ErrorInfo>Call(ErrorInfo.class, "BaiduBCS", bNesisToken, "GetLastError");
		}
		...
		{
			return _bNesisApi.<ErrorInfo[]>Call(ErrorInfo[].class, "BaiduBCS", bNesisToken, "GetErrorLog");
		}
		...
		{
			return _bNesisApi.<Boolean>Call(Boolean.class, "BaiduBCS", bNesisToken, "ValidateToken");
		}
	 ...
	 * if token doesn't support token revocation or token is revoked method returns false 
		...
		{
			return _bNesisApi.<Boolean>Call(Boolean.class, "BaiduBCS", bNesisToken, "Logoff");
		}
	 ...
	 * @return {String} String with normalized path. 
		...
		{
			return _bNesisApi.<String>Call(String.class, "BaiduBCS", bNesisToken, "NormalizePath", path);
		}
	 ...
	 * @return {FileStorageItem[]} Array of IFileStorageItem. 
		...
		{
			return _bNesisApi.<FileStorageItem[]>Call(FileStorageItem[].class, "BaiduBCS", bNesisToken, "GetFiles", path);
		}
	 ...
	 * @return {FileStorageItem[]} Array of IFileStorageItem. 
		...
		{
			return _bNesisApi.<FileStorageItem[]>Call(FileStorageItem[].class, "BaiduBCS", bNesisToken, "GetFolders", path);
		}
	 ...
	 * @return {String} Empty string if OK or an error description otherwise. 
		...
		{
			return _bNesisApi.<String>Call(String.class, "BaiduBCS", bNesisToken, "CreateFolder", path, name);
		}
	 ...
	 * @return {String} Empty string if OK or an error description otherwise. 
		...
		{
			return _bNesisApi.<String>Call(String.class, "BaiduBCS", bNesisToken, "Delete", path);
		}
	 ...
	 * @return {OutputStream} Stream with file or null if error. 
		...
		{
			return _bNesisApi.<OutputStream>Call(OutputStream.class, "BaiduBCS", bNesisToken, "DownloadFile", path);
		}
	 ...
	 * @return {String} Empty string if OK or an error description otherwise. 
		...
		{
			return _bNesisApi.<String>Call(String.class, "BaiduBCS", bNesisToken, "UploadFile", destinationStream, name);
		}
		 ...
		 * @throws Exception
		 */
		public Response GetLoggedInUserRaw() throws Exception
		{
			return _bNesisApi.<Response>Call(Response.class, "BaiduBCS", bNesisToken, "GetLoggedInUserRaw");
		}
}