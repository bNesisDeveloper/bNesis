package bNesis.Sdk.FileStorages.SugarSync;
...
import java.net.URI.*;
	...
	public class SugarSync  
	{
		...
		public SugarSync(bNesisApi bnesisApi)
		{
		 ...
		 */
		public String Auth(String bNesisDevId,String clientId,String clientSecret,String redirectUrl,String login,String password,String data) throws Exception
		{
			bNesisToken = _bNesisApi.Auth("SugarSync", data,bNesisDevId,redirectUrl,clientId,clientSecret,null,login,password,false,"");
			return bNesisToken;
		}
		...
		{
			Boolean result = _bNesisApi.LogoffService("SugarSync", bNesisToken);
		...
		{
			return _bNesisApi.<ErrorInfo>Call(ErrorInfo.class, "SugarSync", bNesisToken, "GetLastError");
		}
		...
		{
			return _bNesisApi.<ErrorInfo[]>Call(ErrorInfo[].class, "SugarSync", bNesisToken, "GetErrorLog");
		}
		...
		{
			return _bNesisApi.<Boolean>Call(Boolean.class, "SugarSync", bNesisToken, "ValidateToken");
		}
	 ...
	 * if token doesn't support token revocation or token is revoked method returns false 
		...
		{
			return _bNesisApi.<Boolean>Call(Boolean.class, "SugarSync", bNesisToken, "Logoff");
		}
	 ...
	 * @return {String} String with normalized path. 
		...
		{
			return _bNesisApi.<String>Call(String.class, "SugarSync", bNesisToken, "NormalizePath", path);
		}
	 ...
	 * @return {FileStorageItem[]} Array of IFileStorageItem. 
		...
		{
			return _bNesisApi.<FileStorageItem[]>Call(FileStorageItem[].class, "SugarSync", bNesisToken, "GetFiles", path);
		}
	 ...
	 * @return {FileStorageItem[]} Array of IFileStorageItem. 
		...
		{
			return _bNesisApi.<FileStorageItem[]>Call(FileStorageItem[].class, "SugarSync", bNesisToken, "GetFolders", path);
		}
	 ...
	 * @return {String} Empty string if OK or an error description otherwise. 
		...
		{
			return _bNesisApi.<String>Call(String.class, "SugarSync", bNesisToken, "CreateFolder", path, name);
		}
	 ...
	 * @return {String} Empty string if OK or an error description otherwise. 
		...
		{
			return _bNesisApi.<String>Call(String.class, "SugarSync", bNesisToken, "Delete", path);
		}
	 ...
	 * @return {OutputStream} Stream with file or null if error. 
		...
		{
			return _bNesisApi.<OutputStream>Call(OutputStream.class, "SugarSync", bNesisToken, "DownloadFile", path);
		}
	 ...
	 * @return {String} Empty string if OK or an error description otherwise. 
		...
		{
			return _bNesisApi.<String>Call(String.class, "SugarSync", bNesisToken, "UploadFile", destinationStream, name);
		}
		...
		{
			return _bNesisApi.<Response>Call(Response.class, "SugarSync", bNesisToken, "GetUserRaw");
		}
}