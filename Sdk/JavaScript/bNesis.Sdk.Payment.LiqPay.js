LiqPay = function (bNesisApi) {
    ...
    this.Auth = function (data,bNesisDevId,redirectUrl,clientId,clientSecret,scopes,login,password,isSandbox,serviceUrl) {
        var bNesisToken = _bNesisApi.Auth("LiqPay", data,bNesisDevId,redirectUrl,clientId,clientSecret,scopes,login,password,isSandbox,serviceUrl);
        return bNesisToken;
    }
    ...
    this.ValidationTokenUnified = function () {
        var result = _bNesisApi.Call("LiqPay", this.bNesisToken, "ValidationTokenUnified");
        return result;
    }
