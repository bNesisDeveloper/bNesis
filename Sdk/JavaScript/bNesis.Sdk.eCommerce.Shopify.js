Shopify = function (bNesisApi) {
    ...
    this.Auth = function (data,bNesisDevId,redirectUrl,clientId,clientSecret,scopes,login,password,isSandbox,serviceUrl) {
        var bNesisToken = _bNesisApi.Auth("Shopify", data,bNesisDevId,redirectUrl,clientId,clientSecret,scopes,login,password,isSandbox,serviceUrl);
        return bNesisToken;
    }
    ...
    this.ValidationTokenUnified = function () {
        var result = _bNesisApi.Call("Shopify", this.bNesisToken, "ValidationTokenUnified");
        return result;
    }
