Stripe = function (bNesisApi) {
    ...
    this.Auth = function (bNesisDevId,clientId,clientSecret,redirectUrl,scopes) {
		if(arguments.length !== 1){
			var bNesisToken = _bNesisApi.Auth("Stripe", "",bNesisDevId,redirectUrl,clientId,clientSecret,scopes,"","",false,"");
			return bNesisToken;
		}
		else{
    ...
    this.LogoffService = function () {
		var result = _bNesisApi.LogoffService("Stripe", this.bNesisToken);
    ...
    this.ValidateToken = function () {
        var result = _bNesisApi.Call("Stripe", this.bNesisToken, "ValidateToken");
        return result;
    }
    ...
    this.Logoff = function () {
        var result = _bNesisApi.Call("Stripe", this.bNesisToken, "Logoff");
        return result;
    }
