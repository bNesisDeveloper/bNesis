BaiduBCS = function (bNesisApi) {
    ...
    this.Auth = function (bNesisDevId,clientId,clientSecret,redirectUrl) {
		if(arguments.length !== 1){
			var bNesisToken = _bNesisApi.Auth("BaiduBCS", "",bNesisDevId,redirectUrl,clientId,clientSecret,null,"","",false,"");
			return bNesisToken;
		}
		else{
    ...
    this.LogoffService = function () {
		var result = _bNesisApi.LogoffService("BaiduBCS", this.bNesisToken);
    ...
    this.ValidateToken = function () {
        var result = _bNesisApi.Call("BaiduBCS", this.bNesisToken, "ValidateToken");
        return result;
    }
    ...
    this.Logoff = function () {
        var result = _bNesisApi.Call("BaiduBCS", this.bNesisToken, "Logoff");
        return result;
    }
