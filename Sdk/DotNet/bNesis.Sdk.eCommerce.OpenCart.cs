...
namespace bNesis.Sdk.eCommerce.OpenCart
{
	public class OpenCart  
	{
		...
		public string Auth(string bNesisDevId,string clientId,string clientSecret,string redirectUrl,string serviceUrl)
		{
			bNesisToken = bNesisApi.Auth("OpenCart", string.Empty,bNesisDevId,redirectUrl,clientId,clientSecret,null,string.Empty,string.Empty,false,serviceUrl);
			return bNesisToken;
		}
