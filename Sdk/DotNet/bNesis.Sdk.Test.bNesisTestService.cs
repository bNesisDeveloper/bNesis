...
namespace bNesis.Sdk.Test.bNesisTestService
{
	public class bNesisTestService  
	{
		...
		{
			bNesisToken = bNesisApi.Auth("bNesisTestProvider", string.Empty,bNesisDevId,redirectUrl,string.Empty,string.Empty,null,string.Empty,string.Empty,false,string.Empty);
			return bNesisToken;
		}
