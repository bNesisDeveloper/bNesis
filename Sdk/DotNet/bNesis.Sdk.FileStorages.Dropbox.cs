...
namespace bNesis.Sdk.FileStorages.Dropbox
{
	public class Dropbox  
	{
		...
		public string Auth(string bNesisDevId,string redirectUrl,string clientId,string clientSecret)
		{
		...
		{
			return bNesisApi.Call<Boolean>("Dropbox", bNesisToken, "ValidationTokenUnified");
		}
