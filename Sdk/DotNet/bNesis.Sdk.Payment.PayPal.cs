...
namespace bNesis.Sdk.Payment.PayPal
{
	public class PayPal  
	{
		...
		{
			bNesisToken = bNesisApi.Auth("PayPal", string.Empty,bNesisDevId,redirectUrl,string.Empty,string.Empty,null,string.Empty,string.Empty,false,string.Empty);
			return bNesisToken;
		}
		...
		{
			bool result = bNesisApi.LogoffService("PayPal", bNesisToken);
