...
namespace bNesis.Sdk.eCommerce.BigCommerce
{
	public class BigCommerce  
	{
		...
		{
			bNesisToken = bNesisApi.Auth("BigCommerce", string.Empty,bNesisDevId,redirectUrl,string.Empty,string.Empty,null,string.Empty,string.Empty,false,string.Empty);
			return bNesisToken;
		}
