...
namespace bNesis.Sdk.eCommerce.Shopify
{
	public class Shopify  
	{
		...
		public string Auth(string data,string bNesisDevId,string redirectUrl,string clientId,string clientSecret,string[] scopes,string login,string password,bool isSandbox,string serviceUrl)
		{
			...
			bNesisToken = bNesisApi.Auth("Shopify", data,bNesisDevId,redirectUrl,clientId,clientSecret,scopes,login,password,isSandbox,serviceUrl);
		...
		{
			return bNesisApi.Call<Boolean>("Shopify", bNesisToken, "ValidationTokenUnified");
		}
