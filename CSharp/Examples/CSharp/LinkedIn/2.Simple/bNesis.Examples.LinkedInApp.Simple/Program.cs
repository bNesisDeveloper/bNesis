...
/// </summary>
namespace bNesis.Examples.LinkedInApp.Simple
{
    /// <summary>
    ...
    /// <para/>bNesis LinkedIn GetMemberSimpleProfileV1 method
    /// <para/>
    ...
    internal class Program
    {
        ...
        {
            Console.WriteLine("bNesis SDK - LinkedIn simple example.\n");
            ...
            else
            {
                ...
                try
                {
                    ...
                    Console.WriteLine("Getting member profile information from LinkedIn...");
                    ...
                    Console.WriteLine("Success! Received information about profile member.");
