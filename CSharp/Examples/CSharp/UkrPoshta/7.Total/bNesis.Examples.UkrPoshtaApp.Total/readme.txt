Example of WPF application.

This WPF application shows how to use bNesis SDK initialization, authentication and call some basic methods from UkrPoshta service.  
