...
This console example shows how to use bNesis SDK initialization, authentication and to get the feed of posts (including status updates) and links published by this person or by others on this person's profile in Facebook service.
