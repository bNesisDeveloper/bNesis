...
This console example shows how to use bNesis SDK initialization, authentication and how to get user friends with the scope "user_friends" in Facebook service.
