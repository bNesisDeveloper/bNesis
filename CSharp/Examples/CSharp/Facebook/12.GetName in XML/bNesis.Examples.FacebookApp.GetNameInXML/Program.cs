...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetNameInXML
{
    /// <summary>
    /// This console example shows how to use bNesis SDK initialization, authentication and how to get the full name of the user (first, middle and last name) without scopes.
    /// All data will be wroten to an XML file to the folder \"container\" in the application folder.
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    Response name = facebook.GetUserFirstMiddleLastNameRaw("me");
                    ...
                    {
                        //Show error message
                        Console.WriteLine("Getting the full name of user is Failed, error code:" + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! The full name of the user is received");
                    ...
                    XDocument xml = XDocument.Load(JsonReaderWriterFactory.CreateJsonReader(
                        Encoding.ASCII.GetBytes(name.Content), new XmlDictionaryReaderQuotas()));

                    //Writing xml document to the file 
                    Directory.CreateDirectory("container");
                    xml.Save("container/data.xml", SaveOptions.None);

                    Console.WriteLine("User's full name is saved to the folder \"container\" in the application folder.");
