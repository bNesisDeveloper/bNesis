...
This console example shows how to use bNesis SDK initialization, authentication and how to get the full name of the user (first, middle and last name) without scopes in Facebook service. All data will be saved to an XML file to the folder \"container\" of console application.
