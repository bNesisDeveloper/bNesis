bNesis SDK Facebook sample.
 ...
 This console example shows how to use bNesis SDK initialization, authentication and to get the feed of posts (including status updates) and links published by this person, or by others on this person's profile in Facebook service. All data will be saved to XML file to a folder \"container\" in the application folder.
