...
This console example shows how to use bNesis SDK initialization, authentication and receiving  data of an authorized user and his friends who gave a permission to provide data to the FacebookApp. All data will be written to XML file in a folder \"container\" in the console application folder.
