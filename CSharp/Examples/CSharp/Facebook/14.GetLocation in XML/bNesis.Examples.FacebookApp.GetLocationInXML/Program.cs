...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetLocationInXML
{
    /// <summary>
    /// This console example shows how to use bNesis SDK initialization, authentication and to get the location of the user with scope "user_location".
    ...
    internal class Program
    {
        ...
        /// </summary>
        private static string[] Scope = new string[] {"user_location" };
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    Response location = facebook.GetUserLocationRaw("me");
                    ...
                    {
                        //Show error message
                        Console.WriteLine("Getting of the user's location is Failed, error code:" + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! The location of the user is received");
                    ...
                    XDocument xml = XDocument.Load(JsonReaderWriterFactory.CreateJsonReader(
                        Encoding.ASCII.GetBytes(location.Content), new XmlDictionaryReaderQuotas()));

                    //Writing xml document to the file
                    Directory.CreateDirectory("container");
                    xml.Save("container/data.xml", SaveOptions.None);

                    Console.WriteLine("The location of the user is saved to the folder \"container\" in the application folder.");
