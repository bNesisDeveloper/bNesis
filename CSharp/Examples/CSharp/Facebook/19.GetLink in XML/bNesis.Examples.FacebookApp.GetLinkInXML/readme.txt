...
This console example shows how to use bNesis SDK initialization, authentication and to get a link to the person's Timeline in Facebook service.
Use without scope. All data will be wroten to the XML file to the folder "container" in the application folder.
