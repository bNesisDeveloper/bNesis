...
This console example shows how to use bNesis SDK initialization, authentication and to get the list devices of the user without scopes in Facebook service. All data are saved to the XML file to the folder \"container\" in the application folder.
