...
/// </summary> 
namespace bNesis.Examples.FacebookApp.GetFavoriteAthletesInXML
{
    /// <summary>
    /// This console example shows how to use bNesis SDK initialization, authentication and to get person's athletes likes.
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    //Getting athletes in the person likes
                    Response athletes  = facebook.GetUserFavoriteAthletesRaw("me");
                    ...
                    {
                        //Show error message
                        Console.WriteLine("Getting athletes in the person likes is Failed, error code:" + errorInfo.Code +
                    ...
                    Console.WriteLine("Success! Athletes in the person likes are received.\n");
                    ...
                    XDocument xml = XDocument.Load(JsonReaderWriterFactory.CreateJsonReader(
                        Encoding.ASCII.GetBytes(athletes.Content), new XmlDictionaryReaderQuotas()));

                    //Writing xml document to the file in 
                    Directory.CreateDirectory("container");
                    xml.Save("container/data.xml", SaveOptions.None);

                    Console.WriteLine("Athletes in the person's likes are saved to the folder \"container\" in the application folder.\n");
                }
