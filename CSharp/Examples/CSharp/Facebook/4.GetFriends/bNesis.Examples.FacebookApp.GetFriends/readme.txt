...
This console example shows how to use bNesis SDK initialization, authentication and to get the user's friends with scope "user_friends" in Facebook service.
